<?php include('./components/header.php');?>
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="https://i.imgur.com/K8ElB8i.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
        <div class="shadow-overlay"></div>
        <div class="home-content">
            <div class="row home-content__main">
                <h1>
                Become the next <br>
                Miss Innovation Nigeria?
                </h1>
                <p>
